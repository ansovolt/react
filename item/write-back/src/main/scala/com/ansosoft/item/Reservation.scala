...
import com.ansosoft.item.Reservation.State
import com.ansosoft.item.{CancelReservation, CloseReservation, ConfirmReservation, CreateReservation, Money, ProductReserved, ReservationCanceled, ReservationClosed, ReservationConfirmed, ReservationCreated, ReservationItem, ReservationOfficeId, ReserveProduct}
